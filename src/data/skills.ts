...
export const SKILLS: SkillNode[] = [
  ...
  n('herb', 'gnome_friend', 'Friend of Gnomes', '🧙', 3, 1, 3, [{ stat: 'autoHarvest', value: 3 }], [{ id: 'deep_roots', rank: 1 }],
    'Garden gnomes help your Gardeners tend 3 more plots.'),
  ...
  n('comm', 'shop_assistant', 'Shop Assistant', '🧑‍💼', 3, 1, 3, [{ stat: 'autoSell', value: 2 }], [{ id: 'word_of_mouth', rank: 3 }],
    'Your Shopkeepers can auto-sell 2 more potion types.'),
  ...
  n('expl', 'familiar_scout', 'Familiar Scout', '🦅', 3, 1, 3, [{ stat: 'autoScav', value: 1 }], [{ id: 'second_pack', rank: 1 }],
    'A falcon familiar lets your Scouts tend 1 more party.'),
  ...
  n('war', 'ritualist', 'Ritualist', '🕯️', 4, 1, 3, [{ stat: 'autoRitual', value: 1 }], [{ id: 'spell_slot', rank: 1 }],
    'Your Scribes can keep 1 more ritual running.'),

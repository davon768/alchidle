...
export const RESEARCH: ResearchDef[] = [
  ...
  { id: 'appr_squire', name: 'Squire\'s Drill', icon: '🤺', level: 14, time: 40 * MIN,
    desc: 'Teach one to carry the pack, and to say get up when you would rather not.',
    cost: [{ id: 'gold', qty: 60000 }, { id: 'ironore', qty: 12 }], unlocksRole: 'squire' },
  { id: 'appr_scribe', name: 'A Scribe\'s Alphabet', icon: '🧙', level: 18, time: 70 * MIN,
    desc: 'The sigils can be copied. Slowly, and by someone else.',
    cost: [{ id: 'gold', qty: 200000 }, { id: 'spellink', qty: 8 }], req: ['annex'], unlocksRole: 'scribe' },

  { id: 'company', name: 'Charter a Company', icon: '🏕️', level: 16, time: 50 * MIN,
  ...
  { id: 'scriptorium', name: 'The Scriptorium', icon: '📜', level: 17, time: 80 * MIN,

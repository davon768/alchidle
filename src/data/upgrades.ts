...
export const UPGRADES: UpgradeDef[] = [
  ...
  { id: 'flame', name: 'Everburning Coal', icon: '🪔', desc: 'Unlocks auto-repeat on cauldrons.', level: 4, baseCost: 300, growth: 1, max: 1, effects: [{ stat: 'autoBrew', value: 1 }] },
  ...
  { id: 'gnome', name: 'Hire a Garden Gnome', icon: '🧙', desc: 'Auto-harvests and replants.', level: 6, baseCost: 750, growth: 1, max: 1, effects: [{ stat: 'autoHarvest', value: 1 }] },
  { id: 'falcon', name: 'Trained Falcon', icon: '🦅', desc: 'Unlocks auto-repeat on expeditions.', level: 8, baseCost: 1500, growth: 1, max: 1, effects: [{ stat: 'autoScav', value: 1 }] },
  { id: 'clerk', name: 'Shop Clerk', icon: '🧑‍💼', desc: 'Unlocks auto-selling potions.', level: 10, baseCost: 2500, growth: 1, max: 1, effects: [{ stat: 'autoSell', value: 1 }] },

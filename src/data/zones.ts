...
export const ZONES: ZoneDef[] = [
  ...
  { id: 'forest', name: 'Old Forest', icon: '🌲', level: 5, time: 45, xp: 8, desc: 'Gnarled trees hide bat roosts.',
    drops: [
  ...
  { id: 'caves', name: 'Crystal Caves', icon: '💎', level: 10, time: 90, xp: 18, desc: 'Glittering veins in the dark.',
    drops: [
  ...
  { id: 'ruins', name: 'Sunken Ruins', icon: '🏛️', level: 18, time: 180, xp: 40, desc: 'A drowned city of forgotten alchemists.',
    drops: [
  ...
  { id: 'spine', name: "Dragon's Spine", icon: '🌋', level: 28, time: 300, xp: 90, desc: 'Volcanic peaks where wyrms shed their scales.',
    drops: [
      { id: 'wyrmscale', min: 1, max: 3, chance: 0.9 },
      { id: 'quartz', min: 5, max: 12, chance: 1 },
      { id: 'phoenix', min: 1, max: 1, chance: 0.08, rare: true },
    ] },
  { id: 'observatory', name: 'Fallen Observatory', icon: '🔭', level: 38, time: 480, xp: 180, desc: 'A star crashed here. Its dust remains.',
    drops: [
      { id: 'stardust', min: 3, max: 8, chance: 1 },
      { id: 'phoenix', min: 1, max: 1, chance: 0.25, rare: true },
      { id: 'relic', min: 1, max: 3, chance: 0.4 },
    ] },
  { id: 'rift', name: 'The Endless Rift', icon: '🌀', level: 50, time: 600, xp: 400, endless: true,
    desc: 'Every descent goes deeper. Rewards grow with depth, forever.',
    drops: [

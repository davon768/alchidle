...
export const ASC_NODES: AscNode[] = [
  ...
  { id: 'automata', name: 'Clockwork Automata', icon: '⚙️', desc: 'All automation unlocked from the start', max: 1, baseCost: 8, growth: 1,
    effects: [{ stat: 'autoHarvest', value: 1 }, { stat: 'autoBrew', value: 1 }, { stat: 'autoSell', value: 1 }, { stat: 'autoScav', value: 1 }] },
